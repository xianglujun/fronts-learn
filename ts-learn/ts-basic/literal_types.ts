...
// 定义一个方法, 该方法只能传入指定的数值
function printText(s: "action" | "store" | "none") {
  console.log(s);
}
...
// 对象
function printOptions(o: Options) {
  console.log(o);
}
printOptions({
  width: 20,
...
function sendRequest(url: string, method: "GET" | "POST" | "CUSTOM") {}
...
sendRequest(httpReq.url, httpReq.method as "GET");
